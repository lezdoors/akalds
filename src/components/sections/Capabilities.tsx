...
export function Capabilities() {
  ...
  return (
    <section
      id="capabilities"
      className="border-t border-stone-200 bg-stone-50 py-24 lg:py-32 text-stone-900"
    >
                ...
                return (
                  <BlurFade key={item.key} delay={0.1 + idx * 0.1} inView>
                    <Link
                      ...
                      className="group grid grid-cols-[3rem_1fr] gap-x-6 border-b border-stone-200 p-7 last:border-b-0 transition-colors hover:bg-stone-50 md:grid-cols-[4rem_1fr] md:p-9"
                    >
